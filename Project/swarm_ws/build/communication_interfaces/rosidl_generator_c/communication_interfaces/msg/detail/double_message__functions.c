...
bool
communication_interfaces__msg__DoubleMessage__are_equal(const communication_interfaces__msg__DoubleMessage * lhs, const communication_interfaces__msg__DoubleMessage * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
communication_interfaces__msg__DoubleMessage__copy(
  const communication_interfaces__msg__DoubleMessage * input,
  communication_interfaces__msg__DoubleMessage * output)
{
  if (!input || !output) {
    return false;
  }
...
communication_interfaces__msg__DoubleMessage__create()
{
  ...
  communication_interfaces__msg__DoubleMessage * msg = (communication_interfaces__msg__DoubleMessage *)allocator.allocate(sizeof(communication_interfaces__msg__DoubleMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
communication_interfaces__msg__DoubleMessage__Sequence__init(communication_interfaces__msg__DoubleMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (communication_interfaces__msg__DoubleMessage *)allocator.zero_allocate(size, sizeof(communication_interfaces__msg__DoubleMessage), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  communication_interfaces__msg__DoubleMessage__Sequence * array = (communication_interfaces__msg__DoubleMessage__Sequence *)allocator.allocate(sizeof(communication_interfaces__msg__DoubleMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
communication_interfaces__msg__DoubleMessage__Sequence__are_equal(const communication_interfaces__msg__DoubleMessage__Sequence * lhs, const communication_interfaces__msg__DoubleMessage__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!communication_interfaces__msg__DoubleMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
communication_interfaces__msg__DoubleMessage__Sequence__copy(
  const communication_interfaces__msg__DoubleMessage__Sequence * input,
  communication_interfaces__msg__DoubleMessage__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(communication_interfaces__msg__DoubleMessage);
    communication_interfaces__msg__DoubleMessage * data =
      (communication_interfaces__msg__DoubleMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!communication_interfaces__msg__DoubleMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          communication_interfaces__msg__DoubleMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!communication_interfaces__msg__DoubleMessage__copy(
