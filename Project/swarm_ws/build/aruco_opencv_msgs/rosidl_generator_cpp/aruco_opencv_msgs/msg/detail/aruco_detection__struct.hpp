...
struct ArucoDetection_
{
  ...
  _header_type header;
  using _markers_type =
    std::vector<aruco_opencv_msgs::msg::MarkerPose_<ContainerAllocator>, typename ContainerAllocator::template rebind<aruco_opencv_msgs::msg::MarkerPose_<ContainerAllocator>>::other>;
  _markers_type markers;
  using _boards_type =
    std::vector<aruco_opencv_msgs::msg::BoardPose_<ContainerAllocator>, typename ContainerAllocator::template rebind<aruco_opencv_msgs::msg::BoardPose_<ContainerAllocator>>::other>;
  _boards_type boards;
  ...
  Type & set__markers(
    const std::vector<aruco_opencv_msgs::msg::MarkerPose_<ContainerAllocator>, typename ContainerAllocator::template rebind<aruco_opencv_msgs::msg::MarkerPose_<ContainerAllocator>>::other> & _arg)
  {
    this->markers = _arg;
    return *this;
  }
  Type & set__boards(
    const std::vector<aruco_opencv_msgs::msg::BoardPose_<ContainerAllocator>, typename ContainerAllocator::template rebind<aruco_opencv_msgs::msg::BoardPose_<ContainerAllocator>>::other> & _arg)
  {
    this->boards = _arg;
    return *this;
  }
